...
def moderator():
    netloc = [urlparse.urlparse(sys.argv[0]).netloc, '', 'plugin.video.live.streamspro', 'plugin.video.bob', 'plugin.video.cpstreams', 'plugin.video.tinklepad', 'plugin.video.metallic']
