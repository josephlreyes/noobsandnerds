...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('[IMDB] New Movies', 'movies&url=featuredimdb', 'trending.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[IMDB] New TV Shows', 'tvshows&url=premiereimdb', 'imdb.png', 'DefaultRecentlyAddedEpisodes.png')
        ...
        if traktCredentials == True: self.addDirectoryItem('Trakt', 'mytvNavigator', 'trakt.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem('[IMDB] Populars', 'movies&url=popularimdb', 'imdb.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[IMDB] New Movies', 'movies&url=featuredimdb', 'imdb.png', 'DefaultRecentlyAddedMovies.png')
		
        self.addDirectoryItem('[TRAKT] Trending', 'movies&url=trending', 'trakt.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def mytvshows(self):
        ...
        if traktCredentials == True:
            ...
            self.addDirectoryItem('[B]TRAKT[/B]: Sync TV Shows', 'traktsync', 'trakt.png', 'DefaultAddonProgram.png')
            self.addDirectoryItem('[B]SETTING[/B]: Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
            self.addDirectoryItem('[B]SETTING[/B]: Clear Providers', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem('[IMDB] Populars', 'tvshows&url=imdbpopular', 'imdb.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem('[IMDB] New TV Shows', 'tvshows&url=premiereimdb', 'imdb.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem('[TRAKT] Trending', 'tvshows&url=trending', 'trakt.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem('[B]CLEANUP[/B]: Library', 'clean_library', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]UPDATE[/B]: Library', 'updateLibrary', 'tools.png', 'DefaultAddonProgram.png')
