...
2. If you want your add-ons to show in the featured/recommended section of the Add-on Portal then you must offer some kind of support to your users. If you don't want to use
the noobsandnerds forum for offering support that is completely fine and entirely your
choice but you will need to either add a forum link in your addon.xml or directly add a
forum link via the Edit Add-on option on the Add-on Portal.
...
content. Whilst this will not affect users installing your content or downloading your
repo they will be warned of possible side-effects.
